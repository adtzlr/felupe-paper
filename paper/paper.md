...
The essential high-level parts of solving problems with FElupe include a field, items like a solid body, boundary conditions and a job. A field for a field container is created by a mesh, a numeric region and a quadrature scheme, see \autoref{fig:field}.
...
![Schematic representation of classes to create a region, fields and a field container.\label{fig:field}](field.svg)
